...
public class TinyUrl2 {
    ...
    private Map<String, String> custom_l2s = new HashMap<String, String>();
    private Map<String, String> custom_s2l = new HashMap<String, String>();
